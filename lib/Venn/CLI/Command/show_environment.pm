package Venn::CLI::Command::show_environment;
...
sub run {
    ...
    my $response = $self->submit_to_api($self->action_path($environment), 'GET');
...
Venn::CLI::Command::show_environment - Shows info for an environment

=head1 SYNOPSIS

$ venn show_environment <environment>
