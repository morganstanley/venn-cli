package Venn::CLI::Command::update_environment;
...
Venn::CLI::Command::update_environment - Updates an environment for providers

=head1 SYNOPSIS

$ venn update_environment <environment> [ --description val ]
