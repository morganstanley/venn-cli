package Venn::CLI::Command::unmap_environment;

=head1 NAME

Venn::CLI::Command::unmap_environment

=head1 DESCRIPTION

Unmap environment from provider.
...
sub run {
    ...
    return $self->handle_all('unmap', 'environment', $environment);
}
...
Venn::CLI::Command::unmap_environment - Unmaps an environment from providers

=head1 SYNOPSIS

$ venn unmap_environment <environment> [--option val ...]
