package Venn::CLI::Command::del_capability;
...
sub run {
    ...
    my $response = $self->submit_to_api($self->attribute_path($capability), 'DELETE');
...
Venn::CLI::Command::del_capability - Deletes an unused capability

=head1 SYNOPSIS

$ venn del_capability <capability>

=head1 DESCRIPTION

Deletes a capability that has no associated providers.
