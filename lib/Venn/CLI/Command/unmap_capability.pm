package Venn::CLI::Command::unmap_capability;
...
sub run {
    ...
    return $self->handle_all('unmap', 'capability', $capability);
}
...
Venn::CLI::Command::unmap_capability - Unmaps a capability from providers

=head1 SYNOPSIS

$ venn unmap_capability <capability> [--option val ...]
